...
<head>
	...
	<!-- Volt CSS -->
	<link type="text/css" href="{{assets('assets-admincss/volt.css')}}" rel="stylesheet">
...
<body>
	...
	<!-- Core -->
	<script src="{{assets('assets-adminvendor/@popperjs/core/dist/umd/popper.min.js')}}"></script>
	<script src="{{assets('assets-admin/vendor/bootstrap/dist/js/bootstrap.min.js')}}"></script>

	<!-- Vendor JS -->
	<script src="{{assets('assets-admin/vendor/onscreen/dist/on-screen.umd.min.js')}}"></script>
</body>
